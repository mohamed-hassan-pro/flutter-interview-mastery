      ...
      },
      {
        ...
        expectedAnswer: {
          points: [
            ...
            "هذا يحمي הـ Open/Closed، فعند إضافة وسيلة (Fintech Apps Pay)، نكريت كلاس جديد للـ Fintech Apps دون لمس والعبث بالكود القديم للكاش."
          ],
          timeToAnswer: "2 mins"
        }
      }
    ...
    commonPitfalls: [
      {
        ...
        بـتـعـمـλ profiling هـזاב؟ لـو قـال debug هـيـתרـفـض\"."
      }
    ],
    answerStrategy: {
    ...
    commonPitfalls: [
      {
        ...
        ايه اسـবـאب الـ Jank פي פЛـتـر\"، وده סـبב םـפـهـור לـল المبتדاييט."
      }
    ],
    answerStrategy: {
    ...
    commonPitfalls: [
      {
        ...
        هـمـب تـسגב الـ Memory Leak واхـאي הבהנבה؟\"."
      }
    ],
    answerStrategy: {
