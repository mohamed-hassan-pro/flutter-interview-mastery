...
export const cardsExtra7: Card[] = [
    mk('behavioral-questions', 96, 'Behavioral Interview Questions', 'أسئلة المقابلة السلوكية',
        ...
        ['STAR: Situation Task Action Result', 'Common: conflict, failure, success, teamwork', '"Tell me about yourself" = 90-second pitch', 'Growth mindset answers', 'Specific numbers in results', 'Egyptian market: hierarchy awareness'],
...
// Common questions in Egyptian companies:
...
// - "Why do you want to leave your current job?"`,
        ...
        ['trella-questions'], 'salary-negotiation', 'Salary Negotiation',
    ...
    mk('salary-negotiation', 97, 'Salary Negotiation', 'التفاوض على الراتب',
        ...
        'Egyptian market salary ranges, negotiation tactics, competing offers, timing',
...
// - Private health insurance = ~2,000 EGP/month value`,
        [
            ...
            q('Theoretical', 'What benefits should you negotiate besides base salary in Egypt?', 'ما المزايا التي يجب التفاوض عليها بجانب الراتب الأساسي؟', 2, ['Health insurance', 'Annual bonus structure', 'Remote work days', 'Training budget']),
            q('Critical Thinking', 'Should you disclose your current salary?', 'هل تكشف عن راتبك الحالي؟', 2, ['Avoid disclosing', '"I\'m targeting X range based on value"', 'Some Egyptian companies require it legally'])
        ],
    ...
    mk('portfolio-tips', 98, 'Portfolio & GitHub Tips', 'نصائح البورتفوليو و GitHub',
        'Junior', 'Critical', ['Interview Skills', 'Career'],
        'Building impressive GitHub profile and portfolio for Egyptian Flutter market',
        ['Pinned repos: 3-5 best projects', 'README with GIFs and features list', 'Clean code with proper architecture', 'Open source contributions', 'Flutter pub.dev packages', 'Technical blog in Arabic = big differentiator'],
...
// - GitHub stats`,
        [
            ...
            q('Critical Thinking', 'What makes a Flutter portfolio project stand out in Egypt?', 'ما الذي يجعل portfolio project Flutter متميزًا في مصر؟', 3, ['Arabic RTL support', 'Egyptian payment integration', 'Real problem solved']),
            ...
            q('Theoretical', 'How important is a technical blog for a Flutter developer?', 'ما أهمية المدونة التقنية لمطور Flutter؟', 2, ['Demonstrates expertise', 'Arabic blog rare = huge differentiator', 'Medium or personal blog'])
        ],
        ['salary-negotiation'], 'resume-writing', 'Resume Writing',
        'Portfolio = proof of work > claims', 'Pinned repos | README+GIF | Architecture | Arabic content',
        ['All Companies'], 'Very High', 'Critical'),

    mk('resume-writing', 99, 'Resume Writing for Flutter Devs', 'كتابة السيرة الذاتية لمطوري Flutter',
        'Junior', 'Critical', ['Interview Skills', 'Career'],
        'Egyptian market CV tips, ATS optimization, Flutter-specific skills to highlight',
        ['One page for < 5 years experience', 'ATS: keywords must match job description', 'Impact metrics: "Reduced load time by 60%"', 'Flutter version: always mention', 'Architecture used: Clean/BLoC/Riverpod', 'Egyptian companies look for: Arabic, payment integration'],
...
//    How do you scale the DB?`,
        ...
        ['Swvl', 'Thndr', 'Valeo', 'International'], 'High', 'Critical'),
