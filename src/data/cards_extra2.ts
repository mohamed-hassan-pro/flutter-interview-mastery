...
export const cardsExtra2: Card[] = [
  ...
  void dispose() {
    ...
    super.dispose();
        ...
        ['Swvl', 'MaxAB', 'Thndr', 'Fawry'], 'Very High', 'Critical'),
...
final router = GoRouter(routes: [
  ...
  ShellRoute(
    ...
    routes: [/* tabs */],
        ...
        ['Swvl', 'MaxAB', 'Thndr', 'Paymob'], 'Very High', 'Major'),
  ...
  child: Column(children: [
    ...
    ElevatedButton(
      ...
      child: Text('Submit'),
        ...
        ['MaxAB', 'Fawry', 'Paymob', 'ITWorx'], 'Very High', 'Moderate'),
...
class _MyState extends State<W> with SingleTickerProviderStateMixin {
  ...
  void dispose() { _ctrl.dispose(); super.dispose(); }
        ...
        ['Swvl', 'MaxAB', 'Valeo'], 'High', 'Moderate'),
...
//   }`,
        ...
        ['Valeo', 'ITWorx', 'International'], 'Low', 'Major for Senior'),
